...
new_slide.innerHTML = `<img src = "assets/img/rosecake.jpeg" />`;
  ...
  function Slider(container, options) {
    ...
    this.showSlide = function (num) {
      ...
      if (this.slides[num]) {
        ...
        getProperty(options.events, "change_slide", function () {})(
          num,
          this.slides[num]
        );
        ...
        if (controls.slides_container) {
          controls.slides_container.style.left =
            "-" + 100 * parseInt(num) + "%";
        }
    ...
    this.pause = function () {
      ...
      if (controls.pause) {
        controls.pause.innerHTML = getProperty(
          options,
          "play_icon",
          DEFAULT_ICONS.pause
        );
    ...
    this.resetTimeout = function () {
      ...
      timeout = setTimeout(function () {
        if (
          getProperty(options, "play_direction", Slider.FORWARDS) ==
          Slider.BACKWARDS
        ) {
          self.prev();
        } else {
    ...
    this.updateView = function () {
      ...
      btn_prev.innerHTML = getProperty(
        options,
        "prev_icon",
        DEFAULT_ICONS.prev
      );
      ...
      btn_next.innerHTML = getProperty(
        options,
        "next_icon",
        DEFAULT_ICONS.next
      );
    ...
    (function () {
      ...
      getProperty(options.events, "load", function () {})(
        controls.slides_container
      );
    })();
